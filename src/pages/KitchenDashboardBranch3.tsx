...
const KitchenDashboardBranch3: React.FC = () => {
  ...
  useEffect(() => {
    // Filter orders for branch 3
    const filtered = orders.filter(order => order.branchId === '3');
  ...
  return (
    <Container>
      <DashboardCard>
        <HeaderSection>
          <Title>👨‍🍳 Kitchen Dashboard - Branch 3</Title>
        </HeaderSection>

        <BranchInfo>
          <p><strong>🏢 Branch:</strong> Branch 3</p>
...
export default KitchenDashboardBranch3;
