...
const KitchenDashboardBranch2: React.FC = () => {
  ...
  useEffect(() => {
    // Filter orders for branch 2
    const filtered = orders.filter(order => order.branchId === '2');
  ...
  return (
    <Container>
      <DashboardCard>
        <HeaderSection>
          <Title>👨‍🍳 Kitchen Dashboard - Branch 2</Title>
        </HeaderSection>

        <BranchInfo>
          <p><strong>🏢 Branch:</strong> Branch 2</p>
...
export default KitchenDashboardBranch2;
